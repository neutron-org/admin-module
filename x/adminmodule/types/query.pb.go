...
func (m *QueryArchivedProposalsResponse) GetProposalsLegacy() []*v1beta1.Proposal {
	if m != nil {
...
var fileDescriptor_2e7b4eebb507dc96 = []byte{
	...
	,
	...
	0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0x45, 0x31, 0x56, 0x17, 0x6a, 0x56, 0x05, 0x8a, 0xc9,
	0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0x0c, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0xaf, 0xb0, 0x37, 0x9b, 0x93, 0x04, 0x00, 0x00,
}
...
type QueryClient interface {
	...
	// Queries a list of archived proposals.
	ArchivedProposalsLegacy(ctx context.Context, in *QueryArchivedProposalsRequest, opts ...grpc.CallOption) (*QueryArchivedProposalsResponse, error)
}
...
func (c *queryClient) ArchivedProposalsLegacy(ctx context.Context, in *QueryArchivedProposalsRequest, opts ...grpc.CallOption) (*QueryArchivedProposalsResponse, error) {
	out := new(QueryArchivedProposalsResponse)
...
type QueryServer interface {
	...
	// Queries a list of archived proposals.
	ArchivedProposalsLegacy(context.Context, *QueryArchivedProposalsRequest) (*QueryArchivedProposalsResponse, error)
}
...
func (*UnimplementedQueryServer) ArchivedProposalsLegacy(ctx context.Context, req *QueryArchivedProposalsRequest) (*QueryArchivedProposalsResponse, error) {
...
func _Query_ArchivedProposalsLegacy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ArchivedProposalsLegacy(ctx, req.(*QueryArchivedProposalsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
