...
func (app *App) ExportAppStateAndValidators(
	...
	if err != nil {
		return servertypes.ExportedApp{}, errors.Wrap(err, "failed to ExportGenesisForModules")
	}
...
func (app *App) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
	...
	if err := app.StakingKeeper.IterateValidators(ctx, func(_ int64, val stakingtypes.ValidatorI) (stop bool) {
		...
		if err := app.DistrKeeper.Hooks().AfterValidatorCreated(ctx, valAddrBech32); err != nil {
			panic(err)
		}
		return false
	}); err != nil {
